...
This script is used to clean the North Temperate Lakes Long Term Ecological Research (NTL LTER) data. Our goal is to clean the daily meteorological data and the ice duration data so that they can be used in our analysis and ingested into a relational database using `DuckDB`.
...
# change the year4 column name to year
...
# check all unique values in the month column
